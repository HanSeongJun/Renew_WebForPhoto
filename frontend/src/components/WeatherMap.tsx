        ...
        <div className="bg-white rounded-lg shadow-lg p-6 h-full">
          ...
          {selectedRegion && (
            <div className="mb-4">
              ...
              {/* 구/군 상세 날씨 정보 */}
              {selectedDistrict && districtWeather && (
                <div className="bg-blue-50 p-3 rounded mb-4">
                  ...
                  <p className="text-sm text-gray-700">미세먼지(PM10): {districtWeather.airQuality.pm10} ({districtWeather.airQuality.pm10Grade})</p>
                  <p className="text-sm text-gray-700">초미세먼지(PM2.5): {districtWeather.airQuality.pm25} ({districtWeather.airQuality.pm25Grade})</p>
                  <p className="text-sm text-gray-700">구름량: {districtWeather.weather.cloudCover}%</p>
                  <p className="text-sm text-gray-700">습도: {districtWeather.weather.humidity}%</p>
                  <p className="text-xs text-gray-400 mt-1">측정시각: {districtWeather.dataTime}</p>
                </div>
              )}
